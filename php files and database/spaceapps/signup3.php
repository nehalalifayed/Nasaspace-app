...
$q = mysqli_query($con,$sql);
 ...
 $q = mysqli_query($con, "UPDATE participant_form SET Name='".$Name."',password='".$password."',edu_institute='".$edu_institute."',team='".$team."',user_id='". $user_id."' WHERE Email='".$Email."'");
...
$subject = 'NASA Space Apps Account Register Password';

$sendto = $Email;

$body = "You have registered with this email, here is your password ".$password; 
